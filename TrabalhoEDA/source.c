 ...
 * @param inicio Apontador para o inicio da lista ligada
*/
int mudarValor(LC formato,Matriz* inicio,int x,int y,int num)
{
    int conta,num,posicao;
    Matriz* aux = inicio;
 ...
 * @return Retorna o apontador para o inicio da lista ligada
*/
Matriz* removeLinha(Matriz* inicio,LC formato,int linha)
{
    int y,linha;
 ...
 * @return Retorna o apontador para o inicio da lista ligada
*/
Matriz* removeColuna(Matriz* inicio,LC formato,int coluna){
    int x,coluna;
    Matriz* apontaI;
    Matriz* apontaF = inicio;
    Matriz* remove;
